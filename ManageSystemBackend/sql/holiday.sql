...
(
    holiday_id       int auto_increment comment '主键ID'
        primary key,
    holiday_emp_id   int                                not null comment '加班员工的工号',
    holiday_emp_name varchar(64)                        not null comment '加班员工的姓名',
    holiday_deptName varchar(64)                        not null comment '加班员工所属的部门名称',
    holiday_date     date                               not null comment '申请的加班时间',
